...
bot_token = "7492452234:AAF_Z0SNBwd3dA6PLq6kt4WjZvHccZtFco4"
chat_id = "-4565050638"
...
while True:
    ...
    print(Fore.YELLOW + Style.BRIGHT + f"1. [ Akademi Pengemis ] Lounge")
...
hiduplah seekor babi
Babi tersebut tidak bisa memakai komputer 
tapi bisa menjadi pejabat di bidang Komunikasi dan Informasi.
babi tersebut yang bisa menjabat menjadi seekor menteri
dikementerian yg sekarang dinamakan KOMINFO.
Babi tersebut berasal dari suatu daerah di kawasan BADLAND yg dinamakan HIndia Belanda

Suatu Kebanggaan punya negara dimana puncaknya adalah Kebun Binatang wkwkwkwkwkw
          """)
    print(Fore.GREEN + Style.BRIGHT + "Blum BOT")
    print(Fore.GREEN + Style.BRIGHT + "Update Link: https://github.com/Doc-SLAV/blumbot")
    print(Fore.YELLOW + Style.BRIGHT + "Free Konsultasi Join Telegram Channel: https://t.me/t.me/zxcvbnmasdfghjklqwertyuiop_12345")
    print(Fore.BLUE + Style.BRIGHT + "Buy me a coffee :) UQA3Ju_LgANl5xX8CN6X31AZzGfT9r3kNq6Fbc82mU8s-QqI <TON Address>")
...
while True:
    try:
        ...
        if notif_tele_enable == 'y':
            ...
            💰 <b>Total Balance:</b> {total_balance_all_accounts:,.0f} <b>BP</b>


            == Nanti di banned nanges ! ==
            """
